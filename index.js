    ...
    const server1 = http.createServer((req, res) => {
        ...
        if (req.url == "/api/util/get_init_params.api") {
            ...
            const get_init_params = {
                ...
                "server_addr": `http://${server}:8071/`,
                "cache_server_addr": `http://${server}:8072/`,
                "photon_server_addr": `http://${server}:8073/`,
                "status_code": 0,
    ...
    const server2 = http.createServer((req, res) => {
        ...
        if (req.url == "/api/util/get_init_params.api") {
            ...
            const get_init_params = {
                ...
                "in_review": false,
                "nonce": "Bda6BffBaSAsi2fa",
                "server_addr": `http://${server}:8081/`,
                "cache_server_addr": `http://${server}:8082/`,
                "photon_server_addr": `http://${server}:8083/`,
                "status_code": 0,
                "system_dl_battle_threshold": 2,
                "system_dl_conv_threshold": 0,
                "system_dl_progress_bar_show": false,
